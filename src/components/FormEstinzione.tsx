        ...
        <div id='form-estinzione' className='box box-orange'>
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className='input-wrapper'>
                    ...
                    <select name='mese' onChange={(e) => handleChange(e)} value={estinzione.mese}>
                        <option key={'option-month-0'} value={0}>
                            Scegli un mese
                        </option>
                        {months.map((month) => {
                            return (
                                <option key={`option-month-${month.date}`} value={month.mese}>
                                    {month.date}
                                </option>
                            );
                        })}
                ...
                <div className='input-wrapper'>
                    <input
                        type='submit'
                        value={`${isUpdate ? 'Aggiorna' : 'Aggiungi'} estinzione`}
                    />
                </div>
            </form>
        </div>
