    ...
    return (
        <div id='box-estinzioni' className='box box-orange'>
            <ul>
                {estinzioni.map((e) => {
                    return (
                        <li key={`estinzione-${e.mese}`}>
                            <span>
                                Estinzione di <strong>{e.estinzione.toFixed(2)} €</strong> del{' '}
                                <strong>{e.date}</strong> con{' '}
                                <strong>{e.risparmioEstinzione.toFixed(2)} €</strong> interessi
                                risparmiati.
                            </span>
...
Estinzioni.propTypes = {
    ...
    removeEstinzione: PropTypes.func.isRequired,
};
