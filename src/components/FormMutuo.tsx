        ...
        <div className='box box-orange'>
            <form>
                ...
                <div className='input-wrapper'>
                    ...
                    <div className='input-container'>
                        <select name='durata' onChange={(e) => handleChange(e)} value={durata}>
                            <option key={'option-durata-0'} value={0}>
                                Scegli una durata
                            </option>
                            {selectData.map((month, year) => {
                                return (
                                    <option key={`option-durata-${month}`} value={month}>
                                        {year} anni
                                    </option>
                                );
                            })}
                ...
                <div className='input-wrapper'>
                    ...
                    <div className='input-container'>
                        <select name='inizio' onChange={(e) => handleChange(e)} value={inizio}>
...
FormMutuo.propTypes = {
    ...
    tasso: PropTypes.string.isRequired,
    capitale: PropTypes.string.isRequired,
